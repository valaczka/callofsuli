...
QtObject {
    ...
    property int gameButtonMinHeight: (Qt.platform.os === "android" || Qt.platform.os === "ios" ? 45 : 40)
    ...
    property var buttonThemeOrange: ["black", colorWarningDarker, colorWarningLighter, colorWarning]
    ...
    property real volumeBackgroundMusic: 0.3
    property real volumeSfx: 0.6
    property real volumeShot: 0.6
    ...
    property string iconStudentQuestion: "image://font/AcademicI/\uf1f6"
    ...
    property string iconPackage: "image://font/Academic/\uf122"
