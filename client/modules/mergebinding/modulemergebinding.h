...
class ModuleMergebinding : public QObject, public ModuleInterface
{
	Q_OBJECT

	Q_PLUGIN_METADATA(IID "org.callofsuli.Modules.mergebinding")
	Q_INTERFACES(ModuleInterface)

public:
	explicit ModuleMergebinding(QObject *parent = nullptr);

	inline QString name() const override { return QStringLiteral("mergebinding"); }
	inline Types types() const override { return Storage; }
	inline QString readableName() const override { return tr("Szakaszolt összerendelés"); }
	inline QString icon() const override { return QStringLiteral("qrc:/Qaterial/Icons/view-sequential.svg"); }

	inline QString qmlEditor() const override { return QStringLiteral("ME_mergebinding.qml"); }
