...
QScrollable {
	...
	property bool _waitForReply: false
	...
	Qaterial.GroupBox {
		...
		enabled: game && game.engineId === -1 && !_waitForReply
	...
	QLabelInformative {
		visible: _waitForReply
		text: qsTr("Várakozás a szerver válaszára...")
		//bottomPadding: 10 * Qaterial.Style.pixelSizeRatio
		topPadding: 20 * Qaterial.Style.pixelSizeRatio
	}
