...
QTabPage {
    ...
    onPageActivatedFirst: {
        if ((Qt.platform.os === "android" || Qt.platform.os === "ios") && height>width && cosClient.getServerSettingBool("notification/gameLandscape", true) === true) {
            ...
            cosClient.setServerSetting("notification/gameLandscape", false)
        }
    }
