...
Item {
    ...
    property int horizontalPadding: Math.max(mainWindow.safeMarginLeft, mainWindow.safeMarginRight)
    property int verticalPadding: Math.max(Qt.platform.os == "android"  || Qt.platform.os === "ios" ? 0 : 5,
                                           mainWindow.safeMarginTop, mainWindow.safeMarginBottom)
