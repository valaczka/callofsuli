...
Column {
    ...
    Row {
        ...
        QLabel {
            ...
            width: Math.min(implicitWidth, col.width
                            -mainWindow.safeMarginLeft-mainWindow.safeMarginRight
                            -imageTrophy.width-(imageMedal.visible ? imageMedal.width : 0))
    ...
    QCollapsible {
        ...
        isFullscreen: true              // safe area

        Column {
            id: collapsibleGameCol

            width: parent.width-mainWindow.safeMarginLeft-mainWindow.safeMarginRight
            x: mainWindow.safeMarginLeft
            bottomPadding: 15
            ...
            Row {
                ...
                QLabel {
                    width: collapsibleGameCol.width/2
            ...
            Row {
                ...
                ProgressBar {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    width: collapsibleGameCol.width/2-labelDuration.width-labelDurationMin.width
                    from: 0
                    to: if (_isFaster)
    ...
    QCollapsible {
        ...
        isFullscreen: true          // safe margins

        Column {
            width: collapsibleGameCol.width
            x: mainWindow.safeMarginLeft
            bottomPadding: 15
            ...
            Row {
                ...
                ProgressBar {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    width: collapsibleGameCol.width/2-labelStreak.width-labelStreakMax.width
                    from: 0
        ...
        Column {
            ...
            Repeater {
                ...
                Row {
                    ...
                    QLabel {
                        id: labelMission
                        width: collapsibleGameCol.width-imgMission.width-btnPlay.width
    ...
    QCollapsible {
        ...
        Column {
            ...
            Row {
                ...
                QLabel {
                    id: labelMission2
                    width: collapsibleGameCol.width-imgMission2.width-btnPlay2.width
