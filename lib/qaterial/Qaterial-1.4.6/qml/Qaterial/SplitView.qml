...
T.SplitView
{
  ...
  property color handleColor: T.SplitHandle.pressed ? Qaterial.Style.primaryTextColor() : Qt.lighter(Qaterial.Style.secondaryTextColor(), T.SplitHandle.hovered ? 1.2 : 1.1)
