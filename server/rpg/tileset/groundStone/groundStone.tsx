...
<tileset version="1.10" tiledversion="1.10.2" name="groundStone" tilewidth="128" tileheight="64" tilecount="56" columns="8">
 <grid orientation="isometric" width="128" height="64"/>
 <image source="stone_path_128x64.png" width="1024" height="448"/>
 <wangsets>
  <wangset name="TerrainSet" type="corner" tile="-1">
   <wangcolor name="GroundStone" color="#ff0000" tile="-1" probability="1"/>
